...
exports.registerUser = asyncHandler(async (req, res, next) => {
  ...
  const options = {
    email: email ? email : "",
    subject: "AnimeClub - Verify your account",
  ...
  const verifyAccountLink =
    process.env.NODE_ENV == "production"
      ? `https://ani-search-club.netlify.app/verify-account/?email=${email}&token=${tokenToVerify}`
...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  const forgotPasswordLink =
    process.env.NODE_ENV == "production"
      ? `https://ani-search-club.netlify.app/reset-password/?email=${email}&token=${resetPasswordToken}`
